...
public class RobotMap {
    ...
    public static final double DRIVETRAIN_FRONT_LEFT_MODULE_ANGLE_OFFSET = Math.toRadians(130);
    ...
    public static final double DRIVETRAIN_FRONT_RIGHT_MODULE_ANGLE_OFFSET = Math.toRadians(135);
    ...
    public static final double DRIVETRAIN_BACK_LEFT_MODULE_ANGLE_OFFSET = Math.toRadians(-105);

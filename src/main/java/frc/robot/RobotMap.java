...
public class RobotMap {
    ...
    public static final double DRIVETRAIN_FRONT_LEFT_MODULE_ANGLE_OFFSET = Math.toRadians(10);
    ...
    public static final double DRIVETRAIN_FRONT_RIGHT_MODULE_ANGLE_OFFSET = Math.toRadians(140);
    ...
    public static final double DRIVETRAIN_BACK_LEFT_MODULE_ANGLE_OFFSET = Math.toRadians(-70);
    ...
    public static final double DRIVETRAIN_BACK_RIGHT_MODULE_ANGLE_OFFSET = Math.toRadians(85);
